...
check_transition_epsilon(Transitions, InputState, _, NextState):-
...
simulate(nfa(InitialState, Transitions, FinalState), Input, StatesList, States, Z):-
  check_transition_epsilon(Transitions, InitialState, Input, NextState),
  simulate(nfa(NextState, Transitions, FinalState), Input, [InitialState | StatesList], States, Z).

simulate(nfa(InitialState, Transitions, FinalState), [ Input | Tail ], StatesList, States, Z):-
  \+ check_transition_epsilon(Transitions, InitialState, _ , _  ),
